...
def shell(title, body, depth=1, kind='', description='Hermes의 작업·지식·카탈로그·이미지·영상 구조를 이해하고 공개 코드로 확인합니다.'):
    ...
    if kind == 'home':
        navigation=''.join(link(base+href,label) for href,label in (
            ('slides/overview/index.html','슬라이드'),('blog/index.html','블로그'),('wiki/start.html','위키')))
        footer_links=f'<a href="{base}blog/index.html">블로그</a><a href="{base}wiki/start.html">위키</a>'
    else:
        navigation=''.join(link(base+href,label) for href,label in (
...
def home():
    body='''<main id="main" class="course-index">
<section class="chapter-intro"><p class="eyebrow">P-HERMES V2</p><h1>무엇을 먼저 볼까요?</h1><p class="lead">p-hermes의 공개 자료를 목적에 맞게 선택합니다.</p></section>
<section class="track-entry" aria-label="자료 선택"><ul class="visual-steps">
<li><h2><a href="slides/overview/index.html">슬라이드</a></h2><p>전체 개념과 학습 흐름을 봅니다.</p></li>
<li><h2><a href="blog/index.html">블로그</a></h2><p>기술 원리와 설계 이유를 읽습니다.</p></li>
<li><h2><a href="wiki/start.html">위키</a></h2><p>정확한 사용법과 사양을 찾습니다.</p></li>
</ul></section>
</main>'''
    write('index.html',shell('p-hermes v2 · 시작하기',body,depth=0,kind='home',description='슬라이드, 블로그, 위키에서 p-hermes를 목적에 맞게 이해합니다.'))
