...
def codepoints():
    p=Text()
    paths=[ROOT/'docs/index.html',*sorted((ROOT/'docs/wiki').glob('*.html')),*sorted((ROOT/'docs/blog').glob('*.html')),*sorted((ROOT/'docs/learn').glob('*.html')),*sorted((ROOT/'docs/slides').rglob('*.html'))]
